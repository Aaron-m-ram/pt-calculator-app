...
var listOfScores = [60,59.5,59.0,58.5,58.0,57.5,57.0,56.5,55.5,55.0,54.5,
...
function returningScore(myRun){
    ...
    for(var i = 0; i< boundariesArr.length; i++){
        ...
        console.log("myRun is less than boundries Score ? " + BigInt(myRun.valueOf()) < BigInt(boundariesArr[i].valueOf()))
